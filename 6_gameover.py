    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        for weapon_idx, weapon_val in enumerate(weapons):
            ...
            if weapon_rect.colliderect(ball_rect):
                weapon_to_remove = weapon_idx # 해당 무기를 없애기 위한 값 걸정
                ball_to_remove = ball_idx

                #가장 작은 크기의 공이 아니라면 나누기
                if ball_img_idx < 3:
                    # 현재 콩 크기 정보를 가지고옴
            ...
            continue # 안쪽 for 문 조건이 맞지 않으면 계속
        break # 안쪽 for문에서 break 만나면 바깥 for문도 break
